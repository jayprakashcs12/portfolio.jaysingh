            ...
            <div className="flex space-x-4">
              {socialMediaLinks.map((link, index) => (
                <a key={index} href={link.socialURL} target="_blank">
                  <link.icon style={{ fontSize: proSize }} className="text-3xl rounded-lg py-2 px-3 md:text-3xl hover:scale-105 duration-200 border-2 border-blue-400 hover:border-blue-800 hover:text-blue-500 cursor-pointer" />
                </a>
              ))}
            </div>
